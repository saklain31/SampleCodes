...
void rotateLeft()
{
    ...
    drawAxis();
    printf("1\n");
    helperLeft(p1,p2,p1,p4);
    printf("2\n");
	helperLeft(p1,p2,p3,p2);
	printf("3\n");
	helperLeft(p3,p2,p3,p4);
	printf("4\n");
	helperLeft(p3,p4,p1,p4);
	degree++;
...
void rotateRight()
{
    ...
    drawAxis();
    printf("1\n");
    helperRight(p1,p2,p1,p4);
    printf("2\n");
	helperRight(p1,p2,p3,p2);
	printf("3\n");
	helperRight(p3,p2,p3,p4);
	printf("4\n");
	helperRight(p3,p4,p1,p4);
	degree--;
