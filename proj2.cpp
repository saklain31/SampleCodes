...
void helperY(int a, int b)
{
    ...
    float cosine = cos((degree2*PI*1.0)/(180*1.0));
	 ...
	 X[a] =  X[a]*cosine +  Z[a]*sine;
	 Y[a] =  Y[a];
	 Z[a] =  X[a]*(-1.0*sine) +  Z[a]*cosine;
	 X[b] =  X[b]*cosine +  Z[b]*sine;;
	 Y[b] =  Y[b];
	 Z[b] =  X[b]*(-1.0*sine)+  Z[b]*cosine;
...
void helperX(int a, int b)
{
    ...
    float cosine = cos((degree3*PI*1.0)/(180*1.0));
	 ...
	 X[a] =  X[a];
	 Y[a] =  Y[a]*cosine- Z[a]*sine;
	 Z[a] =  Y[a]*sine- Z[a]*cosine;

	 X[b] =  X[b];
	 Y[b] =  Y[b]*cosine- Z[b]*sine;
	 Z[b] =  Y[b]*sine- Z[b]*cosine;
